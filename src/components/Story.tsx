      ...
      >
        ...
        <header className="mb-24 text-center">
            <motion.h1 
                ...
                className="font-editorial text-6xl sm:text-8xl lg:text-9xl text-[#4A4A40]"
            >
                {t.story.title}
            </motion.h1>
            <motion.p 
                ...
                className="mt-6 text-xl text-[#B99C88] italic font-editorial"
            >
                {t.story.subtitle}
            </motion.p>
        </header>
        ...
        <div className="grid gap-16 lg:grid-cols-2 lg:gap-24 items-start">
            ...
            <div className="space-y-8 text-lg leading-relaxed text-[#6B6B60] font-light">
                <motion.p
                ...
                >
                    <span className="text-4xl float-left mr-2 mt-[-10px] font-editorial text-[#4A4A40]">I</span> {t.story.p1}
                </motion.p>
                <motion.p
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
        ...
        <div className="max-w-3xl mx-auto text-center">
            <h2 className="font-editorial text-4xl sm:text-6xl text-[#4A4A40] mb-8">{t.story.missionTitle}</h2>
            <p className="text-xl text-[#6B6B60] leading-relaxed mb-12">
                {t.story.missionText}
            </p>
            <p className="text-lg font-editorial italic text-[#B99C88]">
                "{t.story.quote}"
            </p>
            ...
            <div className="mt-16">
                <button 
                    onClick={onBack}
                    className="inline-block border-b border-[#4A4A40] pb-1 text-[#4A4A40] text-sm uppercase tracking-widest hover:border-transparent hover:text-[#B99C88] transition-all"
                >
                    {t.story.returnHome}
                </button>
            </div>
