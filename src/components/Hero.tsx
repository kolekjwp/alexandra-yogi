...
export function Hero() {
  ...
  return (
    <section ref={containerRef} className="relative flex min-h-screen w-full flex-col items-center justify-center overflow-hidden bg-[#FDFBF7] px-4 py-20 text-[#4A4A40] sm:px-8">
      ...
      <motion.div 
        ...
        className="absolute top-[-10%] left-[-10%] h-[60vh] w-[60vh] rounded-full bg-[#E8E4D9] blur-[120px]" 
      />
      <motion.div 
        initial={{ opacity: 0, scale: 0.8 }}
        animate={{ opacity: 0.3, scale: 1 }}
        transition={{ duration: 5, repeat: Infinity, repeatType: "reverse", delay: 1, ease: "easeInOut" }}
        className="absolute bottom-[-10%] right-[-10%] h-[70vh] w-[70vh] rounded-full bg-[#DCCBC1] blur-[150px]" 
      />
      ...
      <div className="relative z-10 flex h-full w-full flex-col justify-center gap-4 sm:gap-8">
        ...
        >
            <h1 className="font-editorial text-[12vw] leading-[0.9] tracking-wide italic text-[#4A4A40] sm:text-[14vw]">
                {t.hero.your}
            </h1>
        </motion.div>
        ...
        >
             <h1 className="font-editorial text-[12vw] leading-[0.9] tracking-wide text-[#4A4A40] sm:text-[14vw]">
                {t.hero.spiritual}
            </h1>
        </motion.div>
        ...
        >
            <h1 className="font-editorial text-[12vw] leading-[0.9] tracking-wide italic text-[#B99C88] sm:text-[14vw]">
                {t.hero.bestie}
            </h1>
        </motion.div>
      </div>
      ...
      >
          <p className="max-w-xs text-center text-sm font-medium uppercase tracking-[0.2em] text-[#6B6B60] sm:text-base">
            {t.hero.guide}
          </p>
      </motion.div>
    </section>
